  ...
  const projects = [
    {
      ...
      description: "A full-stack finance tracker enabling users to log, categorize, and analyze expenses with secure authentication and visual insights.",
    ...
    },
    {
      ...
      description: "Python-based CLI tool for compressing and batch-processing image/video files using OpenCV and FFmpeg.",
    ...
    },
    {
      ...
      description: "An accessible e-commerce web app tailored for visually impaired users with speech recognition and voice navigation.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div 
              key={index} 
              className={`bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 hover:scale-105 ${isVisible ? 'animate-slideInUp' : 'opacity-0 translate-y-[50px]'}`}
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span key={techIndex} className="px-3 py-1 bg-teal-100 dark:bg-teal-900 text-teal-700 dark:text-teal-300 rounded-full text-sm font-medium">
                      {tech}
                    </span>
                  ))}
                </div>
                ...
                <div className="space-y-2 mb-4">
                  {project.achievements.map((achievement, achIndex) => (
                    <p key={achIndex} className="text-sm text-gray-700 dark:text-gray-300 flex items-start gap-2">
