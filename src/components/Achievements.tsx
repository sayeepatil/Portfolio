...
const achievements = [
  ...
  },
  {
    ...
    description:
      "Served as an executive board member in multiple Model United Nations conferences, honing diplomacy, public speaking, and negotiation skills through simulated policy debates.",
    ...
    <section ref={sectionRef} id="achievements" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className={`text-3xl md:text-4xl font-bold text-gray-900 dark:text-white text-center mb-12 transition-all duration-1000 ${isVisible ? 'animate-fadeInUp' : 'opacity-0 translate-y-[30px]'}`}>
          ...
          < span className="text-black dark:text-white">Achieve</span>
          <span className="text-teal-600 dark:text-teal-400">ments</span>
        </h2>
